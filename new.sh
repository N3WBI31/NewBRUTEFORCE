...
echo $i" |"$cy"     SUPPORT BY CYBER GANZ "$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" RelGanz  [N3WBI3]"$i"          |"
echo $i" |"$pu" Youtube :"$ku" RelGanz "$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Mr.k0nsl3t] [Mr.Kiplix] [Dan]"$i"  |"
echo $i" |"$cy"            ~ [Teman Sekolah] [Sahabat Anti Cwe] [Keluarga]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 088210982908"$i"             |"
echo $i" |"$pu" Pesan :"$ku" SUBSCRIBER GW CUMA 3 DOANG TOD SUBCRIBE YAHH:(:"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"N3WBI3"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
